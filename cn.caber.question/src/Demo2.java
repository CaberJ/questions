...
public class Demo2 {
    ...
    public static void main(String[] args) {
        ...
        ListNode listNode14 = new ListNode(4, listNode13);

        ListNode listNode21 = new ListNode(1);
        ListNode listNode22 = new ListNode(2, listNode21);
        ListNode listNode23 = new ListNode(3, listNode22);
        ListNode listNode24 = new ListNode(4, listNode23);

        Integer num = addTwoNumbers(listNode14, listNode24);
